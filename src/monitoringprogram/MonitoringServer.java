...
public class MonitoringServer implements Runnable
{
    ...
    private MonitoringServerThread clients[] = new MonitoringServerThread[50];
    ...
    public synchronized void remove(int ID)
    {
        ...
        if (pos >= 0)
        {
            MonitoringServerThread toTerminate = clients[pos];
    ...
    private void addThread(Socket socket)
    {
        if (clientCount < clients.length)
        {
            ...
            clients[clientCount] = new MonitoringServerThread(this, socket);
            try
            {
